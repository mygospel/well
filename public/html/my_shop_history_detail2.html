		...
		<div class="inner wrap">
			...
			<article class="history-detail-body">
				<div class="detail-body-box">
					...
					<div class="mid-box">기간권</div>
					<div class="bottom-box">
						<div class="time-box type-2">오늘 예약을 해주세요.</div>
						<div class="reserved-box">
							<a href="#none" class="reserved-btn">오늘 예약 하기</a>
						</div>
					...
					<div class="item-list">
						<div class="row">
							...
							<div class="con">
								...
								<div class="link-box"><a href="#none" class="link-btn">예약 변경</a></div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="con">
								...
								<div class="link-box"><a href="#none" class="link-btn">좌석 변경</a></div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="con">
								...
								<div class="link-box"><a href="#none" class="link-btn">사물함 변경</a></div>
							</div>
						</div>
					</div>
