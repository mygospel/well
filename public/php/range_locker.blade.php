...
<body>
<div class="container page-with-btn overlay" style="background-color: #FCFCFC;">
		...
		<div class="inner wrap">
			...
			<article class="history-detail-head" style="padding-bottom: 15px;">
				...
				<div class="detail-sub-box">
					<div class=""><b>사용 시작 시간, 이용기간, 위치</b>를 선택해 주세요! <span class="accent-txt2">(선택사항)</span></div>
				</div>
			</article>
			...
			<article class="voucher-locker-option-group">
				...
				<div class="option-box">
					<div class="subject-box">사용 시작 시간</div>
					<div class="con-box">
						<a class="select-btn" href="javascript:selectOn('time1');" data-select="select1">9:00</a>
					</div>
				</div>

				<div class="option-box">
					<div class="subject-box">사물함 이용기간 선택</div>
					<div class="con-box">
						<a class="select-btn" href="javascript:selectOn('time2');" data-select="select2">1일 이용권 / &nbsp;<b style="">3,000원</b></a>
					</div>
				</div>

			</article>

			<article class="voucher-locker-group">
				...
				<div class="locker-wrap">
					<ul class="locker-list">
						...
						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn">A-1</a>
							</div>
						</li>
						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn on">A-2</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn type-off">A-3</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn type-off">A-4</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn">A-5</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn">A-6</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn">A-7</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn">A-8</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn">A-9</a>
							</div>
						</li>

						<li class="locker-box">
							<div class="item-wrap">
								<a href="#none" class="item-btn">A-10</a>
							</div>
						</li>
				...
				<div class="locker-option">
					...
					<a href="#none" class="prev-btn"></a>
					<div class="locker-txt">1층 복도 A구역</div>
					<a href="#none" class="next-btn"></a>
				</div>


				<article class="information-toggle-list">


					<div class="toggle-item-box">
						<a href="#none" class="toggle-head">취소/환불 안내</a>
						<div class="toggle-body">내용</div>
	...
	<article class="popup popup-msg" style="display: block">
			...
			<div class="popup-msg-group">
				...
				<div class="msg-contents-box">
					...
					<div class="contents-box">
						<div class="txt-box">
							<b>기간권 좌석 및 날짜선택</b>은 이용권 구매 후<br/>
							메인화면에서 설정할 수 있어요!
						</div>
					</div>
	...
	<article class="time-foot-item" data-foot="time2">
		...
		<div class="wrap">
			...
			<div class="item-wrap">
				...
				<div class="tit-box">사물함 이용기간 선택</div>
				<div class="item-list">
					<div class="item-box"><a class="item-btn" href="#none" onclick="selectClick(this,'select2')">1일 이용권 / &nbsp;<b style="">3,000원</b></a></div>
					<div class="item-box"><a class="item-btn type-off" href="#none">1일 이용권 / &nbsp;<b style="">4,000원</b></a></div>
					<div class="item-box"><a class="item-btn" href="#none" onclick="selectClick(this,'select2')">2일 이용권 / &nbsp;<b style="">6,000원</b></a></div>
				</div>
