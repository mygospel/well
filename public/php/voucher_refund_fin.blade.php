...
<div class="container page-with-btn" style=";">
		...
		<div class="inner wrap">
			...
			<article class="voucher-refund-form">
				...
				<div class="refund-info-box">
					...
					<div class="main-box">
						<div class="top-txt">환불 예정금액</div>
						<div class="price-txt">6,000 <span class="unit">원</span></div>
					</div>


					<div class="sub-box">카드 취소 3~5영업일 소요</div>
				</div>
	...
	<article class="page-with-btn">
		<article class="menu-btn-box">
			<a href="/main_type1" class="menu-btn off">환불하기</a>
		</article>
	</article>
