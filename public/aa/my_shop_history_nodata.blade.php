	...
	<section class="my-home-shop-history">
		...
		<div class="inner wrap">
			...
			<div class="tabs-group">
				...
				<div class="history-no-data" style="padding-top: 50px;">

					<article class="voucher-none" style="padding-top: 0;">
						<div class="img-box">
							<img src="/mobile/img/img_voucher_info_img1.svg" alt="이미지">
						</div>
						<div class="txt-box" style="padding-bottom: 7px;">이용 중인 매장이 없어요.</div>
						<div class="link-box">
							<a href="#none" class="link-underline-btn">내 주변 매장 보러 가기</a>
						</div>
					</article>
