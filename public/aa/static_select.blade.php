...
<div class="container page-with-btn" style="background-color: #FCFCFC;">
		...
		<div class="inner wrap">
			...
			<article class="seat-head-box">
				<div class="head-box">
					...
					<div class="sub-txt">고정권 기간을 선택해 주세요!</div>
				</div>
			</article>
				...
				<div class="extend-list" style="padding-top: 22px;">
					<div class="extend-box">
						<label>
							...
							<span class="txt">고정권 4주</span>
							<span class="sub-txt">160,000원</span>
						</label>
					</div>
					...
					<div class="extend-box">
						<label>
							<input type="radio" name="extend">
							<span class="txt">고정권 8주</span>
							<span class="sub-txt">280,000원</span>
						</label>
					</div>
					...
					<div class="extend-box">
						<label>
							<input type="radio" name="extend">
							<span class="txt">고정권 12주</span>
							<span class="sub-txt">400,000원</span>
						</label>
					</div>
	...
	<article class="page-with-btn">
		<article class="menu-btn-box">
			<a href="#none" class="menu-btn off" onclick="popupEvent(this);">고정권 기간을 선택해 주세요</a>
		</article>
	</article>
				...
				<div class="msg-contents-box">
					...
					<div class="msg-check-box">
						...
						<div class="check-item">
							...
							<div class="bottom-box">고정권 4주</div>
						</div>
...
<script>
	...
	$('input[name=extend]').on('change',function (){
		if($('input[name=extend]:checked').length){
			...
			pageWithBtnDisabled('고정권 기간을 선택해 주세요');
		}
	});
