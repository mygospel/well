...
<div class="container" style="background-color: #F9F9FA;">
	...
	<header style="">
		<div class="wrap" >
			<article class="header-page-group border-line" style="background-color: #F9F9FA">
				<a href="#none" class="back-btn"></a>
				<div class="page-txt">찜 목록</div>
			</article>
		</div>
	</header>
				...
				<ul class="item-list">
					...
					<li class="item-box">
						...
						<div class="info-box">
							...
							<div class="img-box">
								<img src="/mobile/img/img_view_dummy1.png" alt="더미">
							</div>
							...
							<div class="con-box">
								...
								<div class="place-box">
									...
									<span class="place-txt">마포구 대흥로 360</span>
								...
								<div class="coupon-box">
									<div class="coupon-item">할인 쿠폰!</div>
								</div>
								<div class="link-box">
									<a href="#none" class="link-btn">지금 예약하러 가기</a>
								</div>
