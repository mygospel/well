			...
			<article class="voucher-calendar-group">
				...
				<div class="voucher-time-select-box" style="padding-top: 0; margin-top: 0; border:0; border-bottom:2px solid #EFF0F7">
					...
					<div class="time-box">
						...
						<a href="javascript:timeSelectOn();" class="time-btn time1">9:00</a>
					</div>
	...
	<article class="time-foot-item">
		...
		<div class="wrap">
			...
			<div class="item-wrap">
				...
				<div class="item-list">
					<div class="item-box"><a href="javascript:timeSelectOff('time1','9:00');" class="item-btn">9:00</a></div>
					...
					<div class="item-box"><a href="javascript:timeSelectOff('time1','13:00');" class="item-btn">13:00</a></div>
					<div class="item-box"><a href="javascript:timeSelectOff('time1','14:00');" class="item-btn">14:00</a></div>
					<div class="item-box"><a href="javascript:timeSelectOff('time1','14:00');" class="item-btn">15:00</a></div>
					<div class="item-box"><a href="javascript:timeSelectOff('time1','15:00');" class="item-btn">16:00</a></div>
					<div class="item-box"><a href="javascript:timeSelectOff('time1','16:00');" class="item-btn">17:00</a></div>
					<div class="item-box"><a href="javascript:timeSelectOff('time1','17:00');" class="item-btn">18:00</a></div>
				</div>
...
<script>
	...
	function timeSelectOff(element, txt){
		...
		$('.'+element).addClass('active').text(txt);
