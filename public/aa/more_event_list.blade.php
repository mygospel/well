	...
	<section class="board-type2">
		...
		<div class="inner wrap">
			<article class="board-type2-group">
				...
				<div class="board-type2-list">

					<a href="#none" class="board-item">
						<div class="img-box">
							<img src="/mobile/img/img_event_dummy1.png" alt="이미지">
						</div>
					</a>

					<a href="#none" class="board-item">
						<div class="img-box">
							<img src="/mobile/img/img_event_dummy2.png" alt="이미지">
						</div>
					</a>

					<a href="#none" class="board-item type-end">
						<div class="img-box">
							<img src="/mobile/img/img_event_dummy3.png" alt="이미지">
						</div>
