	...
	<section class="more-home">
		...
		<div class="inner wrap">
			...
			<div class="more-menu-list">
				<div class="more-menu-btn type-toggle">
					<article class="toggle-input-box">
						<label>
							<div class="txt-box">이메일 알림</div>
				...
				<div class="more-menu-btn" style="border-bottom:0;">
					<div class="txt-box">버전 정보</div>
					<div class="txt-box">0.0.0</div>
				</div>
			</div>
