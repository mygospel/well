		...
		<div class="inner wrap">
			...
			<article class="history-detail-head" style="padding-bottom: 15px;">
				...
				<div class="detail-sub-box">
					<div class="">예약하고 싶은 이용권을 선택해 주세요!</div>
				</div>
			</article>

			<article class="voucher-select-group">
				...
				<div class="select-wrap">
					<ul class="select-list">
						...
						<li class="select-item">
							...
							<div class="item-wrap">
								<a href="#none" class="item-btn-box">
									<div class="img-box">
										<img src="/mobile/img/img_voucher_item1.svg" alt="이미지">
									</div>

									<div class="top-box">하루 이용권</div>

									<div class="bottom-box">원하는 시간에 예약이<br/>
										가능해요.</div>
								</a>
							</div>
						...
						<li class="select-item">
							...
							<div class="item-wrap">
								<a href="#none" class="item-btn-box">
									<div class="img-box">
										<img src="/mobile/img/img_voucher_item2.svg" alt="이미지">
									</div>
									<div class="top-box">고정석</div>

									<div class="bottom-box">선택한 좌석을 지정석으로<br/>
										이용이 가능해요.</div>
								</a>
							</div>
						...
						<li class="select-item">
							...
							<div class="item-wrap">
								<a href="#none" class="item-btn-box">
									<div class="img-box">
										<img src="/mobile/img/img_voucher_item3.svg" alt="이미지">
									</div>

									<div class="top-box">시간권</div>

									<div class="bottom-box">선택한 시간만큼 자유롭게<br/>예약이 가능해요.</div>
								</a>
							</div>
						...
						<li class="select-item">
							...
							<div class="item-wrap">
								<a href="#none" class="item-btn-box">
									<div class="img-box">
										<img src="/mobile/img/img_voucher_item4.svg" alt="이미지">
									</div>
									<div class="top-box">정액권</div>

									<div class="bottom-box">원하는 금액을 충전하고<br/>
										자유롭게 예약이 가능해요.</div>
								</a>
							</div>
						...
						<li class="select-item">
							...
							<div class="item-wrap">
								<a href="#none" class="item-btn-box">
									<div class="img-box">
										<img src="/mobile/img/img_voucher_item5.svg" alt="이미지">
									</div>

									<div class="top-box">기간권</div>

									<div class="bottom-box">선택한 기간 동안 자유롭게<br/>
										예약이 가능해요.</div>
								</a>
							</div>
						...
						<li class="select-item">
							...
							<div class="item-wrap">
								<a href="#none" class="item-btn-box">
									<div class="img-box">
										<img src="/mobile/img/img_voucher_item6.svg" alt="이미지">
									</div>
									<div class="top-box">스터디룸 당일권</div>

									<div class="bottom-box">원하는 시간에 스터디룸<br/>
										예약이 가능해요.</div>
								</a>
							</div>
