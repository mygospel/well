...
<div class="container" style="background-color: #F9F9FA;">
	...
	<section class="my-mileage">
		...
		<div class="inner wrap">
			...
			<article class="mileage-head">

				<div class="head-box">

					<div class="head-txt">보유 마일리지</div>
			...
			<article class="mileage-history" style="padding-top: 144px;">

				<div class="tit-box">

					<div class="txt-box">

						<div class="tit-txt">마일리지 적립내역</div>
				...
				<div class="list-box">
					...
					<div class="list-item">
						...
						<div class="subject-box">
							<div class="main-txt">ABC 스터디 카페</div>
						</div>
						<div class="con-box">
							<div class="mileage-txt">+1000마일리지 적립</div>
						</div>
