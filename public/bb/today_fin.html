...
<body>
<div class="container footer-none" style="background: #FCFCFC">

	<header>
		<div class="wrap">
			<article class="header-page-group" style="">
				<div class="page-txt">결제완료</div>
	...
	<section class="pay-fin">

		<article class="pay-fin">

			<div class="img-box">
				<img src="/mobile/img/img_voucher_info_img6.svg" alt="이미지">
			</div>

			<div class="txt-box">
				9월 1일 토요일 9시 - 18시<br/>
				D1 좌석 예약<span class="normal">이 완료 되었어요!</span>
			</div>
		</article>

	</section>

	<article class="pay-fin-menu">

		<article class="menu-btn-box">
			<a href="#none" class="menu-btn type-1">이용권 보러가기</a>
		</article>

		<div class="sub-box">
			<a href="#none" class="sub-btn">홈으로 가기</a>
		</div>
	</article>
