                ...
                <li class="nav-item dropdown dropdown-large">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <div class="row row-cols-3 g-3 p-3">
                            ...
                            <div class="col text-center btn_member_register" nextStep="buyProduct">
                                <div class="app-box mx-auto bg-gradient-kyoto text-dark"><i class='bx bx-notification'></i>
                                </div>
                                <div class="app-title">회원가입</div>
                            </div>
                            <div class="col text-center" id="btn_util_buyProduct" nextStep="reservSeat">
                        ...
                        <div class="header-message-list">
                            <a class="dropdown-item" href="javascript:;">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="msg-name">조현준님의 1:1 문의가 등록되었습니다. <span class="msg-time float-end">신규</span></h6>
                                        <p class="msg-info">2020-10-10 22:00:00</p>
                                    </div>
                                </div>
                            </a>
                            <a class="dropdown-item" href="javascript:;">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="msg-name">최현우님의 1:1 문의가 등록되어씃ㅂ니다. <span class="msg-time float-end">답변준비</span></h6>
                                        <p class="msg-info">2020-10-10 22:00:00</p>
                                    </div>
                                </div>
                            </a>
                            <a class="dropdown-item" href="javascript:;">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="msg-name">조현준님의 1:1 문의가 등록되었습니다. <span class="msg-time float-end">답변완료</span></h6>
                                        <p class="msg-info">2020-10-10 22:00:00</p>
                                    </div>
                                </div>
                            </a>
        ...
        <div class="user-box dropdown">
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="user-info ps-3">
                    <p class="user-name mb-0 text-white">{{ Auth::guard("partner")->user()->mn_name ?? "" }}</p>
                    <p class="designattion mb-0">{{ Auth::guard("partner")->user()->mn_name  ?? ""  }} </p>
                </div>
            </a>
