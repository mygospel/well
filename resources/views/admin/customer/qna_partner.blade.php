                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">파트너 1:1문의</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                                ...
                                <div class='row'>
                                    <div class="col-md-2 col-sm-6 col-xs-12 mt-1">
                                        <select class="single-select form-control-sm col-12" name="answer" id="answer">
                                            <option value="" @if( !isset($param['answer']) && $param['answer'] == "" ) selected @endif>전체</option>
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-6 mt-1 justify-content-right">
                                        <!--a href="javascript:;" class="btn btn-warning px-2 btn-sm col-12" data-bs-toggle="modal" data-bs-target="#customFormModal">임시작성</a-->
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table mb-0 table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="">{{ $custom['p_name']  }}</td>
                                    <td><a href="/customer/partner/view/{{ $custom['q_no'] }}">{{ $custom['q_title'] }}</a></td>
