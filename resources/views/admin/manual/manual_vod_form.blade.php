            ...
            <div class="card col-lg-9 col-md-9 col-sm-12">
                ...
                <div class='card-body'>
                    <form enctype="multipart/form-data" method="post" name="form1" id="form1" class="row g-3">
                        ...
                        @else
                        <input type="hidden" name="rURL" value="/manual/vod">
                        @endif
                        ...
                        <div class="col-md-12">
                            <label class="form-label">영상URL</label>
                            <input type="text" name="vod" maxlength="50" class="form-control form-control-sm" value="{{ $board["b_vod"] ?? '' }}">
                        </div>
                        <div class="col-12">
