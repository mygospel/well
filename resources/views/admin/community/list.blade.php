                                ...
                                <div class='row'>
                                    <!--div class="col-md-2 col-sm-3 col-xs-12 mt-1">
                                        <select class="single-select form-control-sm col-12" name="" id="">
                                            <option value="" @if( isset($fd) && $fd == "" ) selected @endif>전체</option>
                                            <option value="name" @if( isset($fd) && $fd == "name" ) selected @endif>답변대기</option>
                                            <option value="title" @if( isset($fd) && $fd == "title" ) selected @endif>답변완료</option>
                                        </select>
                                    </div-->
                                    <div class="col-md-2 col-sm-3 col-xs-12 mt-1">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 mt-1 justify-content-right">
                                        <a href="/community/{{ $b_id ?? '' }}/form" class="btn btn-warning px-2 btn-sm col-12">신규</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table mb-0 table-striped">
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <td><a href="/community/{{ $b_id }}/form/{{ $board['b_no'] }}">{{ $board['b_title'] }}</a></td>
