    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">커뮤니티</div>
                <div class="ps-3">
                            ...
                            <form name="search" action="">
                                ...
                                <div class='row'>
                                    ...
                                    <div class="col-md-2 col-sm-6 col-xs-12 mt-1">
                                        <select name="kind" id="kind" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                                            <option value="">분류선택</option>
                                            <option value="T">Top</option>
                                            @foreach( $faq_categorys as $k => $v )
                        ...
                        <div class="card-body">
                            ...
                            <table class="table mb-0 table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $custom['q_top'] }}</td>
                                    <td class="text-center">{{ $custom['q_kind_name'] }}</td>
                                    <td><a href="#" class="custom_item" custom="{{ $custom['q_no'] }}">{{ $custom['q_title'] }}</a></td>
                                    <td class="text-center">{{ $custom['q_read'] }}</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 mt-3">
                        <select name="seq" id="seq" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                            <option value="">분류내순서</option>
                            @for( $i=20;$i>=1;$i-- )
                    ...
                    <div class="col-xs-12 mt-3">
                        <select name="top" id="top" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                            <option value="">TOP 이면 순서</option>
                            @for( $i=20;$i>=1;$i-- )
            ...
            $.ajax({
                ...
                success: function (res, textStatus, xhr) {
                    ...
                    if (res.custom != null) {
                        ...
                        $("#title").val(res.custom.title);
                        $("#top").val(res.custom.top);
                        $("#seq").val(res.custom.seq);
                        $("#cont").val(res.custom.cont);
                        $("#customFormModal").modal("show");
                    } else {
                        $("#customDetail_msg").html(res.message);
                        console.log("실패.");
                    }
