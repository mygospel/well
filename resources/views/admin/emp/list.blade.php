                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive-sm">
                        <table class="table mb-0">
                            ...
                            <tr class="admin_item" admin="{{ $admin['admin_no'] ?? '' }}" data-bs-toggle="modal" data-bs-target="#adminDetailModal">
                                ...
                                <td class="text-center d-none d-sm-table-cell">{{ $admin['admin_email'] ?? '' }}</td>
                                <td class="text-center d-none d-md-table-cell">{{ $admin['admin_phone'] ?? '' }}</td>
                                <td class="text-center">
                                    @if( $admin['admin_state'] == "Y" )
                                        <span class="btn btn-xs btn-success">승인</span>
                                    @elseif( $admin['admin_state'] == "N" )
                                        <span class="btn btn-xs btn-warning">미승인</span>
                                    @elseif( $admin['admin_state'] == "X" )
                                        <span class="btn btn-xs btn-secondary">차단</span>
                                    @endif
                                </td>
                                <td class="text-center d-none d-md-table-cell"> {{ $admin['created_at'] ?? '' }} </td>
                                <td class="text-center d-none d-md-table-cell"> {{ $admin['admin_login_last'] ?? '' }} </td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
