...
class BoardController extends Controller
{
    ...
    public function index(Request $request){
        ...
        //dd(DB::getQueryLog());
        return view('admin.community.list' , $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        $result = [];
        if( $request->no ) {
            $board = \App\Models\Board::where('b_no', $request->no)->firstOrFail();
        } else {
            $board = new Board();
        }
    ...
    public function form(Request $request){
        ...
        return view('admin.community.form', $data);
    }
